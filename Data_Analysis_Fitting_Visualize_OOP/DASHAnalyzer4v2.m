...
%       CurrentFile;
   ...
   methods (Access = public)
      ...
      function obj =DASHAnalyzer4v2()%Constructor
        %'*x*.cs*'
        ...
        for  i= 1:length(obj.SortedFileslist2)
            ...
            [str, remain] = strtok(str, 'x');
             if(strcmp(str,previousresolution))
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)]; % Multiply By Frame Rate
...
%         hold off
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)];%Mutiply By Frane Rate
