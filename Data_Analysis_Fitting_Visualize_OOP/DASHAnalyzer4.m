...
%Class Definition
%%
classdef DASHAnalyzer4
    
   properties (Access = public)
      Folder='TearsOfSteel_30fbs_Statistics/';
      Framerate=30;
...
%       CurrentFile;
   ...
   methods (Access = public)
      ...
      function obj =DASHAnalyzer4()%Constructor
        %'*x*.cs*'
            ...
            [str, remain] = strtok(str, 'x');
             if(strcmp(str,previousresolution))
                ...
                num2=str2num(char(num2));
                 obj.AllPoints_Pixelrates=[ obj.AllPoints_Pixelrates;(num1 * num2)*30];
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)* 30]; % Multiply By Frame Rate
...
%         hold off
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)*30];%Mutiply By Frane Rate
