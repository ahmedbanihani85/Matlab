function [fitresult, gof] = ExpoFit3(pixelsRate, MAX_Resoultion_Watt_On,figtitle, xTitle, yTitle)
...
xlabel FPS
ylabel Watts
title( strcat(figtitle,' -',yTitle,' =',formula(ft)))
grid on
disp(coeffvalues(fitresult));
saveas(fig,strcat(pwd ,'/Curvefitting_4-25-2018/', strcat(figtitle,' ',yTitle),'.jpg'));