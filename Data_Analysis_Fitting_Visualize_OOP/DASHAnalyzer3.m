...
%Class Definition
%%
classdef DASHAnalyzer3
    
   properties (Access = public)
      Folder='TearsOfSteel_20fbs_Statistics/';
      Framerate=20;
...
%       CurrentFile;
   ...
   methods (Access = public)
      ...
      function obj =DASHAnalyzer3()%Constructor
        %'*x*.cs*'
            ...
            [str, remain] = strtok(str, 'x');
             if(strcmp(str,previousresolution))
                ...
                num2=str2num(char(num2));
                 obj.AllPoints_Pixelrates=[ obj.AllPoints_Pixelrates;(num1 * num2)*20];
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)* 20]; % Multiply By Frame Rate
...
%         hold off
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)*20];%Mutiply By Frane Rate
