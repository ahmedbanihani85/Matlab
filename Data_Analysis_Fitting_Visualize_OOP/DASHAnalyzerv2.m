...
%       CurrentFile;
   ...
   methods (Access = public)
      ...
      function obj =DASHAnalyzerv2()%Constructor
        %'*x*.cs*'
            ...
            [str, remain] = strtok(str, 'x');
             if(strcmp(str,previousresolution))
                ...
                num2=str2num(char(num2));
                 obj.AllPoints_Pixelrates=[ obj.AllPoints_Pixelrates;(num1 * num2)];
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)];%Multiply resolution by frame rate
...
%         hold off
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)];%Multibly by Frame Rate
