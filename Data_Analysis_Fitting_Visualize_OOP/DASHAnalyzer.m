...
%Class Definition
%%
classdef DASHAnalyzer
    
   properties (Access = public)
      Folder='TearsOfSteel_6fbs_Statistics/';
      Framerate=6;
...
%       CurrentFile;
   ...
   methods (Access = public)
      ...
      function obj =DASHAnalyzer()%Constructor
        %'*x*.cs*'
            ...
            [str, remain] = strtok(str, 'x');
             if(strcmp(str,previousresolution))
                ...
                num2=str2num(char(num2));
                 obj.AllPoints_Pixelrates=[ obj.AllPoints_Pixelrates;(num1 * num2)*6];
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)*6];%Multiply resolution by frame rate
...
%         hold off
                ...
                num1=str2num(char(num1));
                num2=str2num(char(num2));
                obj.Pixles_in_Resoultion_Max_On=[obj.Pixles_in_Resoultion_Max_On; (num1 * num2)*6];%Multibly by Frame Rate
